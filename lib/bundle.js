...
class Board {
	...
	animate(time) {
		...
		this.game.draw(this.ctx, this.gameState, this.animationState, this.currentMove, this.animationTime, this.animationTimeTotal );
...
class Game {
	...
	draw(ctx, gameState, animationState, currentMove, animationTime, animationTimeTotal) {
